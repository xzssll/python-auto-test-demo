...
### 第 2 周剩余（6/26-29）：日志 + README + AI文档 + CI

| 天 | 晚（1.5h） | 产出 |
|----|-----------|------|
| **6/26 周四** | ①**日志系统**：安装loguru，替换所有print ②整理Mock笔记 | 日志就绪 + Mock笔记 |
| **6/27 周五** | **README.md** + **AI辅助测试实践文档** | README + AI文档 |
| **6/28 周六(4h)** | **CI流水线**：GitHub Actions push自动跑pytest + Allure报告 + **HttpRequest封装** | CI绿灯 + 请求层封装 |
...
Mock 已跑通，原计划 6/24-25 的 "DB断言恢复" 和 "README"，实际完成了代码审计+旧项目复盘。

**明日（6/26）任务**：
1. 装上 loguru，把项目中所有 `print()` 换成 logger
2. 用你自己的话写一份 Mock 笔记发给我
