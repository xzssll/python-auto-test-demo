...
| 天 | 晚（1.5h） | 产出 |
|----|-----------|------|
| **6/25 周三** | 整理 Mock 笔记（用自己的话写） | Mock 理解文档 |
| **6/26 周四** | ①安装loguru，替换所有print ②README.md | 日志就绪 + README |
| **6/27 周五** | **AI辅助测试实践文档** | AI文档就绪 |
| **6/28 周六(4h)** | **CI流水线**：GitHub Actions + Allure + HttpRequest封装 | CI绿灯 + 请求层封装 |
